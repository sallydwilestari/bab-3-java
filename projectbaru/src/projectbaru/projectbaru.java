...
//                    Integer.parseInt(b)));
//             String nama = "selly";
//             String jurusan = "Sistem Informsi";
//             JOptionPane.showMessageDialog(null, "Halo " + nama + ",jurusan Kamu " + jurusan);
//              JOptionPane.showMessageDialog(null, "Sebuah Informasi.","Informasi",
...
//                         JOptionPane.PLAIN_MESSAGE);
                int pertanyaan = 
              JOptionPane.showConfirmDialog(null, "Pilih Yes atau No ?", "Pertanyaan",
      ...
      if(JOptionPane.YES_OPTION == pertanyaan){JOptionPane.showMessageDialog(null, "kamu memilih Yes.");
          ...
          JOptionPane.showMessageDialog(null, "Kamu milih NO"); 
